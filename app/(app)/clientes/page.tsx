...
const columns: Column<Client>[] = [
  ...
  },
  {
    ...
    render: (r) =>
      r.comercial_email ? (
        <a href={`mailto:${r.comercial_email}`} className="text-blue-600 hover:underline text-xs">
          {r.comercial_email}
        </a>
      ) : (
    ...
    <div className="flex flex-col gap-6">
      <div>
        ...
        <p className="mt-1 text-sm text-gray-500">
          {count > 0
            ? `${count.toLocaleString('es-CL')} clientes registrados.`
            : 'Listado de clientes con deuda activa.'}
        </p>
      </div>
