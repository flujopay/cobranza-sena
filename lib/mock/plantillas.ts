...
export const PREVIEW_FACTURAS: FacturaEjemplo[] = [
  ...
  {
    folio: 'F-00901',
    fecha_emision: '15/02/2026',
    fecha_vencimiento: '17/03/2026',
    dias_mora: 8,
    monto: 640_000,
  },
  {
...
Área de Cobranza`,
  ...
  // ─── SMS ───────────────────────────────────────────────────────────────────
  {
    ...
    cuerpo:
      '{{empresa_emisora}}: Tiene {{total_facturas}} factura(s) pendiente(s) por ${{monto_total}}. Consultas: {{telefono_contacto}}',
  ...
  },
  {
    ...
    cuerpo:
      '{{empresa_emisora}}: Tiene {{total_facturas}} factura(s) por ${{monto_total}} próximas a vencer. Evite recargos: {{telefono_contacto}}',
    variables: ['{{empresa_emisora}}', '{{total_facturas}}', '{{monto_total}}', '{{telefono_contacto}}'],
    activa: true,
  },
  {
    ...
    nombre: 'Aviso mora',
    cuerpo:
      '{{empresa_emisora}}: Tiene {{total_facturas}} factura(s) vencida(s) por ${{monto_total}}. Regularice: {{telefono_contacto}}',
    variables: ['{{empresa_emisora}}', '{{total_facturas}}', '{{monto_total}}', '{{telefono_contacto}}'],
    activa: true,
  },
  {
    ...
    nombre: 'Último aviso',
    cuerpo:
      'URGENTE {{empresa_emisora}}: Deuda ${{monto_total}} ({{total_facturas}} factura(s)) en proceso de cobranza legal. Contacte {{telefono_contacto}} antes del {{fecha_limite}}.',
    variables: [
      '{{empresa_emisora}}',
      '{{total_facturas}}',
      '{{monto_total}}',
