...
export const apiGet = <T>(path: string) => apiClient.get<T>(path).then((r) => r.data)

export const apiPost = <T>(path: string, body: unknown) => apiClient.post<T>(path, body).then((r) => r.data)

export const apiPatch = <T>(path: string, body: unknown) => apiClient.patch<T>(path, body).then((r) => r.data)

export const apiDelete = <T>(path: string) => apiClient.delete<T>(path).then((r) => r.data)
