...
const NIVELES: {
...
}[] = [
  {
    ...
    label: 'Recordatorio',
    emoji: '🟢',
    hint: 'Factura por vencer o recién vencida',
    color: '#059669',
    bg: '#ecfdf5',
  },
  {
  ...
  },
  {
    ...
    label: 'En Mora',
    emoji: '🟠',
    hint: 'Vencida entre 8 y 30 días',
    color: '#c2410c',
    bg: '#fff7ed',
  },
  {
    ...
    label: 'Crítico',
    emoji: '🔴',
    hint: 'Más de 30 días sin pago — gestión legal',
    color: '#b91c1c',
    bg: '#fef2f2',
  },
]
              ...
              {CANALES.map((c) => (
                ...
                >
                  ...
                  <div className="flex-1">
                    <p
                      className={`text-sm font-semibold ${canal === c.value ? 'text-brand' : 'text-gray-700'}`}
                    >
                      {c.label}
                    </p>
                ...
                >
                  <span className="text-base">
                    ...
                    <span
                      ...
                      style={{ color: nivel === n.value ? n.color : '#374151' }}
                    >
                      {n.label}
                    </span>
                  </span>
        ...
        <div className="flex flex-col gap-4 px-6 py-5">
          ...
          <div className="flex items-center gap-2 flex-wrap">
            <span className="flex items-center gap-1.5 text-xs bg-gray-100 text-gray-600 px-2.5 py-1 rounded-full">
              <span className="text-gray-400">
                {canalInfo.icon && (
                  <span style={{ display: 'inline-flex', width: 12, height: 12 }}>{canalInfo.icon}</span>
                )}
              </span>
              {canalInfo.label}
            </span>
            <span
              ...
              style={{ background: nivelInfo.bg, color: nivelInfo.color }}
            >
          ...
          <div>
            <label className="block text-xs font-semibold text-gray-500 mb-2">
              ...
              <span className="font-normal text-gray-400">· clic para insertar en el cursor</span>
            </label>
          ...
          <div>
            <div className="flex items-center justify-between mb-1.5">
              ...
              <div className="flex items-center gap-3">
                {isSms && (
                  <span
                    className={`text-[11px] font-medium ${cuerpo.length > 160 ? 'text-red-500' : 'text-gray-400'}`}
                  >
                    {cuerpo.length}/160
                  </span>
                )}
            ...
            {preview ? (
              ...
              <div
                className={[
                  ...
                  canal === 'whatsapp'
                    ? 'bg-[#e9f5dc] border-[#d0e8b0] font-[system-ui]'
              ...
              >
                ...
                <p className="mt-3 pt-3 border-t border-current/10 text-[11px] text-gray-400 italic">
                  Vista previa con datos de ejemplo — las variables se reemplazarán con los datos reales del
                  deudor.
                </p>
              </div>
            ) : (
        ...
        <div>
          ...
          <div
            className={[
              ...
              canal === 'whatsapp'
                ? 'bg-[#e9f5dc] border-[#d0e8b0]'
                : 'bg-gray-50 border-gray-200 font-mono text-gray-700',
            ].join(' ')}
          >
            {canal === 'whatsapp' ? (
              <div dangerouslySetInnerHTML={{ __html: renderPreview(cuerpo, canal!) }} />
