    ...
    <div className="px-6 py-5 flex flex-col gap-5">
      ...
      <div className="rounded-xl bg-blue-50 border border-blue-100 px-4 py-3 flex gap-3 items-start">
        ...
        <p className="text-xs text-blue-700 leading-relaxed">
          Tus credenciales se usan exclusivamente para consultar el SII y extraer facturas vencidas. Se
          almacenan encriptadas y puedes revocarlas en cualquier momento.
        </p>
      </div>
