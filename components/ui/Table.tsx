          ...
          <div style={{ padding: '4px' }}>
            {PAGE_OPTIONS.map((n) => (
              <button
                ...
                onMouseEnter={(e) => {
                  if (value !== n) e.currentTarget.style.background = '#f9fafb'
                }}
                onMouseLeave={(e) => {
                  if (value !== n) e.currentTarget.style.background = 'transparent'
                }}
              >
                <span>{n} filas</span>
                {value === n && (
  ...
  return (
    <div style={{ display: 'flex', alignItems: 'center', gap: 3 }}>
      {pageRange(page, totalPages).map((p, i) =>
        p === '…' ? (
          <span key={`e${i}`} style={{ padding: '0 4px', color: '#9ca3af', fontSize: 12 }}>
            …
          </span>
        ) : (
          <button
            ...
            onMouseEnter={(e) => {
              if (page !== p) e.currentTarget.style.background = '#f3f4f6'
            }}
            onMouseLeave={(e) => {
...
export function Table<T>({
  ...
  const displayFrom = isServer
    ? serverPagination!.from
    : sorted.length === 0
      ? 0
      : (safePage - 1) * localPerPage + 1
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 8, flexShrink: 0, flexWrap: 'wrap' }}>
          ...
          <span style={{ fontSize: 12, color: '#9ca3af' }}>
            {isLoading
              ...
              : displayCount === 0
                ? '0 resultados'
                : `${displayFrom}–${displayTo} de ${displayCount}`}
          </span>
              ...
              {columns.map((col) => {
                ...
                return (
                  <th
                    ...
                    onMouseEnter={(e) => {
                      if (canSort && !isSorted) e.currentTarget.style.color = '#6b7280'
                    }}
                    onMouseLeave={(e) => {
                      if (!isSorted) e.currentTarget.style.color = '#9ca3af'
                    }}
                  >
            ...
            {isLoading ? (
              ...
              <tr>
                <td
                  ...
                  style={{ padding: '56px 16px', textAlign: 'center', color: '#9ca3af', fontSize: 13 }}
                >
              ...
              paged.map((row, i) => (
                <tr
                  ...
                  style={{
                    borderBottom: i < paged.length - 1 ? '1px solid #f3f4f6' : 'none',
                    transition: 'background 0.1s',
                  }}
      ...
      {totalPages > 1 && (
        ...
        >
          <button
            ...
            onMouseEnter={(e) => {
              if (safePage !== 1) e.currentTarget.style.borderColor = '#3771D1'
            }}
          ...
          <button
            ...
            onMouseEnter={(e) => {
              if (safePage !== totalPages) e.currentTarget.style.borderColor = '#3771D1'
            }}
            onMouseLeave={(e) => (e.currentTarget.style.borderColor = '#e5e7eb')}
          >
            Siguiente
