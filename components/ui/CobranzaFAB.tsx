  ...
  return (
    <div className="px-6 py-6 flex flex-col gap-4">
      <p className="text-sm text-gray-500 leading-relaxed">
        El agente analizará tus facturas vencidas, calculará el score de riesgo de cada deudor y comenzará a
        enviar mensajes personalizados por el canal adecuado.
      </p>
...
export function CobranzaFAB() {
  ...
  useEffect(() => {
    ...
    setPos(clamp(window.innerWidth + DEFAULT_POS.x - 180, window.innerHeight + DEFAULT_POS.y - 48))
  }, [])
